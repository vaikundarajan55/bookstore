...
function ConfirmDialog({ 
  ...
  userPreview = null // object containing user details for success layouts
}) {
  return (
...
export default function BookList() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 font-sans min-h-screen bg-gray-50/50">

      {/* ── Header ── */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-5 border-b border-gray-150">
        <div>
          <h1 className="text-2xl font-black text-gray-900 tracking-tight">System Identity Center</h1>
      ...
      {/* ── Controls ── */}
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 bg-white rounded-2xl shadow-sm p-4 border border-gray-100">
        <div className="flex-1">
      ...
      <div className="bg-white shadow-sm rounded-2xl border border-gray-200 overflow-hidden">
        ...
        {pageSize !== 0 && totalPages > 1 && (
          <div className="bg-white px-6 py-4.5 border-t border-gray-150 flex items-center justify-between">
            <button
              onClick={() => goToPage(currentPage - 1)}
              disabled={currentPage === 1}
              className="px-3.5 py-1.5 rounded-lg border border-gray-200 text-xs font-semibold text-gray-600 hover:bg-gray-50 disabled:opacity-50 disabled:hover:bg-transparent transition flex items-center gap-1.5"
            >
      ...
      {/* ── FLOW MODAL: REGISTER / ADD NEW USER ── */}
      <Modal open={addOpenModel} onClose={() => setAddOpenModel(false)}>
        <div className="p-6">
          <div className="flex items-center justify-between pb-4 border-b border-gray-100">
            <h3 className="text-lg font-bold text-gray-900">Add System User Profile</h3>
            <button onClick={() => setAddOpenModel(false)} className="text-gray-400 hover:text-gray-600 transition">
      ...
      {/* ── FLOW MODAL: CONFIGURE / EDIT EXISTING USER ── */}
      <Modal open={editOpen} onClose={() => setEditOpen(false)}>
        <div className="p-6">
          <div className="flex items-center justify-between pb-4 border-b border-gray-100">
            <h3 className="text-lg font-bold text-gray-900">Configure User Settings</h3>
      ...
      {/* ── FLOW CONTROL CONFIRM DIALOG OVERLAY ── */}
